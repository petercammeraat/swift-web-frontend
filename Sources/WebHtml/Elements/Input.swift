...
///
/// For more information, see [input docs](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input)
open class Input: EmptyElement {
...
public extension Input {
    ...
    /// Specifies the name of form field to use for sending the element's directionality in form submission
